...
class BaiduMapDAO(object):
    ...
    def savePlaceDetail(self, data):
        ...
        for poi in data['results']:
            ...
            try:
                cursor.execute( \
                        "insert into nanjingpoi(name,lat,lng,address,uid,telephone,type,tag,detail_url,price,shop_hours,overall_rating,taste_rating,service_rating,environment_rating,facility_rating,hygiene_rating,technology_rating,image_num,comment_num,favorite_num,checkin_num,groupon_num,discount_num)\
